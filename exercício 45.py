...
# de cada produto e calcule o preço novo. Calcule
# também, a média dos preços com e sem aumento.
# Mostre o código e o preço novo de cada produto e, no
# final, as médias. A entrada de dados deve terminar
# quando for lido um código de produto negativo.

#preco_atual = float(input("Digite o preço: R$ "))

#while preco_atual >= 0:
#     print(f"Preço com acrécimo: R${preco_atual * 1.2:.2f}, média com e sem almento: {preco_atual + (preco_atual * 1.2) / 2:.2f}")
#     preco_atual = float(input("Digite o preço: R$ "))
